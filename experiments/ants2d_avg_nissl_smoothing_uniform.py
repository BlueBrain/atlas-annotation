...
def main():
    ...
    df_3d = ndimage.uniform_filter1d(df_3d, size=3, axis=0)
    # Below are alternative smoothing filters. They all give similar results.
    # df_3d = ndimage.gaussian_filter1d(df_3d, sigma=1, axis=0),
    # df_3d = ndimage.correlate1d(df_3d, weights=[1 / 4, 1 / 2, 1 / 4], axis=0)
